...
var (
	ExampleError = Constructor{
		...
		Web: &WebConstructor{
			HttpStatusCode: entities_http.StatusInternalServerError,
			WsStatusCode:   entities_ws.StatusInternalServerError,
		},
	}
...
func TestGrpcError(t *testing.T) {
	// Step 1
	{
		...
		if err.StatusCode() != entities_grpc.StatusInternalServerError {
...
func TestWebHttpError(t *testing.T) {
	// Step 1
	{
		...
		if err.StatusCode() != entities_http.StatusInternalServerError {
...
func TestWebWsError(t *testing.T) {
	// Step 1
	{
		...
		if err.StatusCode() != entities_ws.StatusInternalServerError {
...
func TestBasicFieldsError(t *testing.T) {
	...
	// Step 2
	{
		var (
			srcErr = errors.New("Test fields error. ")
			err    = ExampleFieldsErrorEmptyMessage.SetError(srcErr).Build().ToBasic()
		)
...
func TestWebFieldsError(t *testing.T) {
	...
	// Step 2
	{
		var (
			srcErr = errors.New("Test fields error. ")
			err    = ExampleFieldsErrorEmptyMessage.SetError(srcErr).Build().ToWeb()
		)
...
func TestMarshalBasicError(t *testing.T) {
	// JSON
	{
		var (
			srcErr         = errors.New("Test error. ")
			err            = ExampleError.SetError(srcErr).Build().ToBasic()
			exampleMarshal = []byte{123, 34, 99, 111, 100, 101, 95, 109, 101, 115, 115, 97, 103, 101, 34, 58, 34, 85, 110, 107, 110, 111, 119, 110, 34, 44, 34, 101, 114, 114, 111, 114, 34, 58, 123, 34, 105, 100, 34, 58, 49, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 44, 34, 109, 101, 115, 115, 97, 103, 101, 34, 58, 34, 84, 101, 115, 116, 32, 101, 114, 114, 111, 114, 46, 32, 34, 44, 34, 116, 121, 112, 101, 34, 58, 34, 98, 97, 115, 105, 99, 34, 125, 44, 34, 109, 101, 115, 115, 97, 103, 101, 34, 58, 34, 69, 120, 97, 109, 112, 108, 101, 32, 101, 114, 114, 111, 114, 32, 109, 101, 115, 115, 97, 103, 101, 46, 32, 34, 44, 34, 115, 116, 97, 116, 117, 115, 34, 58, 34, 102, 97, 105, 108, 101, 100, 34, 125}
		)
	...
	// YAML
	{
		var (
			srcErr         = errors.New("Test error. ")
			err            = ExampleError.SetError(srcErr).Build().ToBasic()
			exampleMarshal = []byte{99, 111, 100, 101, 95, 109, 101, 115, 115, 97, 103, 101, 58, 32, 85, 110, 107, 110, 111, 119, 110, 10, 101, 114, 114, 111, 114, 58, 10, 32, 32, 32, 32, 105, 100, 58, 32, 49, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 10, 32, 32, 32, 32, 109, 101, 115, 115, 97, 103, 101, 58, 32, 39, 84, 101, 115, 116, 32, 101, 114, 114, 111, 114, 46, 32, 39, 10, 32, 32, 32, 32, 116, 121, 112, 101, 58, 32, 98, 97, 115, 105, 99, 10, 109, 101, 115, 115, 97, 103, 101, 58, 32, 39, 69, 120, 97, 109, 112, 108, 101, 32, 101, 114, 114, 111, 114, 32, 109, 101, 115, 115, 97, 103, 101, 46, 32, 39, 10, 115, 116, 97, 116, 117, 115, 58, 32, 102, 97, 105, 108, 101, 100, 10}
		)
