...
// WebHttpAddon - внутренняя реализация дополнения ошибки.
type WebHttpAddon struct {
	*internal.Internal
	*WebHttpAddonOptions
}

// WebHttpAddonOptions - опции внутренней реализации ошибки.
type WebHttpAddonOptions struct {
	WebHttpStatusCode StatusCode
}

// StatusCode - получение статус кода ошибки.
func (instance WebHttpAddon) StatusCode() (status StatusCode) {
	return instance.WebHttpStatusCode
}

// toMap - упаковка в map.
func (instance WebHttpAddon) toMap() (data map[string]any) {
	data = map[string]any{
...
func (instance WebHttpAddon) MarshalJSON() (data []byte, err error) {
	return json.Marshal(instance.toMap())
}

// MarshalYAML - упаковка в YAML.
func (instance WebHttpAddon) MarshalYAML() (data any, err error) {
	return instance.toMap(), nil
}

// MarshalXML - упаковка в XML.
func (instance WebHttpAddon) MarshalXML(e *xml.Encoder, start xml.StartElement) (err error) {
	var (
